...
class TeacherDashboard extends Component {
    ...
    deleteExam(examId) {
        var res;
        const token = sessionStorage.getItem('jwt')
        fetch(`https://node-new.herokuapp.com/users/deleteExam`, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                "accept": "application/json",
    ...
    message(){
        return(
            <p>Are you sure you want to <strong>delete</strong> the <strong> {this.state.examName} </strong> exam? Once deleted all the related records with Examination <strong> {this.state.examName} </strong> will be deleted and the changes will not be reverted.</p>
        );
    }
            ...
            return (
                <div>
                    ...
                    <div className="examList-present row">
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <div className="start-button">
                                            ...
                                            <div className="action-button">
                                                ...
                                                <button className="submit-button error-background" onClick={() => {this.setState({ examName: list.ExamName, selectedExam: list.ExamId }); this.displayPopup()}} value="Report" id="ResponseDetails">Delete</button>
                        ...
                        <Popup function={this.deleteExam} parameter={this.state.selectedExam} message={this.message()} title="Delete"/>
                    </div>
                </div>
            );
        }
